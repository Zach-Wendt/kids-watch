...
const requests = {
  ...
  requestFamily: `https://api.themoviedb.org/3/search/movie?api_key=${key}&language=en-US&query=family&page=1&&certification_country=US&certification=G&include_adult=false`,
